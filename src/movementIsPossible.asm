...
section .data
  ...
  strongholdPointOfReference          db    0, 0        ;  Fila y columna fuera del tablero que sirve como punto de referencia para saber si una pieza se esta moviendo hacia la fortaleza o no.
...
section .text
  ...
  initStrongholdPointOfReference:
    ...
    strongholdIsUp:
      mov     byte[strongholdPointOfReference],    -1
      mov     byte[strongholdPointOfReference + 1],    3
      ret

    strongholdIsRight:
      mov     byte[strongholdPointOfReference],    3
      mov     byte[strongholdPointOfReference + 1],    7
      ret
      
    strongholdIsDown:
      mov     byte[strongholdPointOfReference],    7
      mov     byte[strongholdPointOfReference + 1],    3
      ret

    strongholdIsLeft:
      mov     byte[strongholdPointOfReference],    3
      mov     byte[strongholdPointOfReference + 1],    -1
      ret
